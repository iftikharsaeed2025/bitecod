import { EMPTY_OBJ, NO, NOOP, PatchFlagNames, __commonJS, __esm, __export, __toCommonJS, camelize, capitalize, extend, generateCodeFrame, init_runtime_dom_esm_bundler, init_shared_esm_bundler, isArray, isBuiltInDirective, isHTMLTag, isMathMLTag, isObject, isOn, isReservedProp, isSVGTag, isString, isSymbol, isVoidTag, makeMap, parseStringStyle, runtime_dom_esm_bundler_exports, shared_esm_bundler_exports, slotFlagsText, toHandlerKey } from "./runtime-dom.esm-bundler-bxINyfmg.js";
...
var init_compiler_core_esm_bundler = __esm({ "node_modules/@vue/compiler-core/dist/compiler-core.esm-bundler.js": (() => {
...
Use a v-bind binding combined with a v-on listener that emits update:x event instead.`,
	...
	prohibitedKeywordRE = /* @__PURE__ */ new RegExp("\\b" + "arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b") + "\\b");
	stripStringRE = /'(?:[^'\\]|\\.)*'|"(?:[^"\\]|\\.)*"|`(?:[^`\\]|\\.)*\$\{|\}(?:[^`\\]|\\.)*`|`(?:[^`\\]|\\.)*`/g;
...
var init_compiler_dom_esm_bundler = __esm({ "node_modules/@vue/compiler-dom/dist/compiler-dom.esm-bundler.js": (() => {
...
var require_vue_cjs = /* @__PURE__ */ __commonJS({ "node_modules/vue/dist/vue.cjs.js": ((exports) => {
...
var require_vue = /* @__PURE__ */ __commonJS({ "node_modules/vue/index.js": ((exports, module) => {
	module.exports = require_vue_cjs();
}) });

//#endregion
//#region node_modules/vue-resizable/dist/vue-resizable.umd.min.js
var require_vue_resizable_umd_min = /* @__PURE__ */ __commonJS({ "node_modules/vue-resizable/dist/vue-resizable.umd.min.js": ((exports, module) => {
	(function(t, e) {
		...
		return function() {
			var e = {
				365: function(t$1, e$1, i$1) {
					i$1.r(e$1);
					var s$1 = i$1(81), n$1 = i$1.n(s$1), r = i$1(645), h = i$1.n(r), a = h()(n$1());
					a.push([
						t$1.id,
				...
				645: function(t$1) {
					t$1.exports = function(t$2) {
						var e$1 = [];
						return e$1.toString = function() {
							return this.map((function(e$2) {
								var i$1 = "", s$1 = "undefined" !== typeof e$2[5];
								return e$2[4] && (i$1 += "@supports (".concat(e$2[4], ") {")), e$2[2] && (i$1 += "@media ".concat(e$2[2], " {")), s$1 && (i$1 += "@layer".concat(e$2[5].length > 0 ? " ".concat(e$2[5]) : "", " {")), i$1 += t$2(e$2), s$1 && (i$1 += "}"), e$2[2] && (i$1 += "}"), e$2[4] && (i$1 += "}"), i$1;
							})).join("");
						}, e$1.i = function(t$3, i$1, s$1, n$1, r) {
							"string" === typeof t$3 && (t$3 = [[
								null,
								t$3,
								void 0
							]]);
							var h = {};
							if (s$1) for (var a = 0; a < this.length; a++) {
								var o = this[a][0];
								null != o && (h[o] = !0);
							}
							for (var l = 0; l < t$3.length; l++) {
								var c = [].concat(t$3[l]);
								s$1 && h[c[0]] || ("undefined" !== typeof r && ("undefined" === typeof c[5] || (c[1] = "@layer".concat(c[5].length > 0 ? " ".concat(c[5]) : "", " {").concat(c[1], "}")), c[5] = r), i$1 && (c[2] ? (c[1] = "@media ".concat(c[2], " {").concat(c[1], "}"), c[2] = i$1) : c[2] = i$1), n$1 && (c[4] ? (c[1] = "@supports (".concat(c[4], ") {").concat(c[1], "}"), c[4] = n$1) : c[4] = "".concat(n$1)), e$1.push(c));
							}
						}, e$1;
					};
				},
				...
				82: function(t$1, e$1) {
					e$1.Z = (t$2, e$2) => {
						const i$1 = t$2.__vccOpts || t$2;
						for (const [s$1, n$1] of e$2) i$1[s$1] = n$1;
						return i$1;
					};
				},
				733: function(t$1, e$1, i$1) {
					var s$1 = i$1(365);
					s$1.__esModule && (s$1 = s$1.default), "string" === typeof s$1 && (s$1 = [[
						t$1.id,
						s$1,
						""
					]]), s$1.locals && (t$1.exports = s$1.locals);
					var n$1 = i$1(650).Z;
					n$1("833bf5a8", s$1, !0, {
						sourceMap: !1,
						shadowMode: !1
				...
				650: function(t$1, e$1, i$1) {
					function s$1(t$2, e$2) {
						for (var i$2 = [], s$2 = {}, n$2 = 0; n$2 < e$2.length; n$2++) {
							var r$1 = e$2[n$2], h$1 = r$1[0], a$1 = r$1[1], o$1 = r$1[2], l$1 = r$1[3], c$1 = {
								id: t$2 + ":" + n$2,
								css: a$1,
								media: o$1,
								sourceMap: l$1
							};
							s$2[h$1] ? s$2[h$1].parts.push(c$1) : i$2.push(s$2[h$1] = {
								id: h$1,
								parts: [c$1]
							});
						}
					...
					i$1.d(e$1, { Z: function() {
						return f;
					} });
					var n$1 = "undefined" !== typeof document;
					if ("undefined" !== typeof DEBUG && DEBUG && !n$1) throw new Error("vue-style-loader cannot be used in a non-browser environment. Use { target: 'node' } in your Webpack config to indicate a server-rendering environment.");
					var r = {}, h = n$1 && (document.head || document.getElementsByTagName("head")[0]), a = null, o = 0, l = !1, c = function() {}, d = null, u = "data-vue-ssr-id", m = "undefined" !== typeof navigator && /msie [6-9]\b/.test(navigator.userAgent.toLowerCase());
					function f(t$2, e$2, i$2, n$2) {
						l = i$2, d = n$2 || {};
						var h$1 = s$1(t$2, e$2);
						return p(h$1), function(e$3) {
							for (var i$3 = [], n$3 = 0; n$3 < h$1.length; n$3++) {
								var a$1 = h$1[n$3], o$1 = r[a$1.id];
								o$1.refs--, i$3.push(o$1);
							}
							e$3 ? (h$1 = s$1(t$2, e$3), p(h$1)) : h$1 = [];
							for (n$3 = 0; n$3 < i$3.length; n$3++) {
								o$1 = i$3[n$3];
								if (0 === o$1.refs) {
									for (var l$1 = 0; l$1 < o$1.parts.length; l$1++) o$1.parts[l$1]();
									delete r[o$1.id];
								}
							}
						};
					...
					function p(t$2) {
						for (var e$2 = 0; e$2 < t$2.length; e$2++) {
							var i$2 = t$2[e$2], s$2 = r[i$2.id];
							if (s$2) {
								s$2.refs++;
								for (var n$2 = 0; n$2 < s$2.parts.length; n$2++) s$2.parts[n$2](i$2.parts[n$2]);
								for (; n$2 < i$2.parts.length; n$2++) s$2.parts.push(v(i$2.parts[n$2]));
								s$2.parts.length > i$2.parts.length && (s$2.parts.length = i$2.parts.length);
							} else {
								var h$1 = [];
								for (n$2 = 0; n$2 < i$2.parts.length; n$2++) h$1.push(v(i$2.parts[n$2]));
								r[i$2.id] = {
									id: i$2.id,
									refs: 1,
									parts: h$1
					...
					function b() {
						var t$2 = document.createElement("style");
						return t$2.type = "text/css", h.appendChild(t$2), t$2;
					}
					function v(t$2) {
						var e$2, i$2, s$2 = document.querySelector("style[" + u + "~=\"" + t$2.id + "\"]");
						if (s$2) {
							if (l) return c;
						...
						if (m) {
							var n$2 = o++;
							s$2 = a || (a = b()), e$2 = z.bind(null, s$2, n$2, !1), i$2 = z.bind(null, s$2, n$2, !0);
						} else s$2 = b(), e$2 = w.bind(null, s$2), i$2 = function() {
							s$2.parentNode.removeChild(s$2);
						};
						return e$2(t$2), function(s$3) {
							if (s$3) {
								if (s$3.css === t$2.css && s$3.media === t$2.media && s$3.sourceMap === t$2.sourceMap) return;
								e$2(t$2 = s$3);
							} else i$2();
						};
					}
					var g = function() {
						var t$2 = [];
						return function(e$2, i$2) {
							return t$2[e$2] = i$2, t$2.filter(Boolean).join("\n");
						};
					}();
					function z(t$2, e$2, i$2, s$2) {
						var n$2 = i$2 ? "" : s$2.css;
						if (t$2.styleSheet) t$2.styleSheet.cssText = g(e$2, n$2);
						else {
							var r$1 = document.createTextNode(n$2), h$1 = t$2.childNodes;
							h$1[e$2] && t$2.removeChild(h$1[e$2]), h$1.length ? t$2.insertBefore(r$1, h$1[e$2]) : t$2.appendChild(r$1);
						}
					}
					function w(t$2, e$2) {
						var i$2 = e$2.css, s$2 = e$2.media, n$2 = e$2.sourceMap;
						if (s$2 && t$2.setAttribute("media", s$2), d.ssrId && t$2.setAttribute(u, e$2.id), n$2 && (i$2 += "\n/*# sourceURL=" + n$2.sources[0] + " */", i$2 += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(n$2)))) + " */"), t$2.styleSheet) t$2.styleSheet.cssText = i$2;
						else {
							while (t$2.firstChild) t$2.removeChild(t$2.firstChild);
							t$2.appendChild(document.createTextNode(i$2));
						}
					}
				},
				203: function(e$1) {
			...
			function s(t$1) {
				var n$1 = i[t$1];
				if (void 0 !== n$1) return n$1.exports;
				var r = i[t$1] = {
					id: t$1,
					exports: {}
				};
				return e[t$1](r, r.exports, s), r.exports;
			}
			(function() {
				s.n = function(t$1) {
					var e$1 = t$1 && t$1.__esModule ? function() {
						return t$1["default"];
					} : function() {
						return t$1;
					};
					return s.d(e$1, { a: e$1 }), e$1;
				};
			})(), function() {
				s.d = function(t$1, e$1) {
					for (var i$1 in e$1) s.o(e$1, i$1) && !s.o(t$1, i$1) && Object.defineProperty(t$1, i$1, {
						enumerable: !0,
						get: e$1[i$1]
					});
				};
			}(), function() {
				s.o = function(t$1, e$1) {
			...
			return function() {
				if (s.r(n), s.d(n, { default: function() {
					...
					var t$1 = window.document.currentScript, e$1 = t$1 && t$1.src.match(/(.+\/)[^/]+\.js(\?.*)?$/);
					e$1 && (s.p = e$1[1]);
				}
				var i$1 = s(203);
				function r(t$2, e$2, s$1, n$1, r$1, h$1) {
					return (0, i$1.openBlock)(), (0, i$1.createElementBlock)("div", {
						ref: "parent",
						class: "resizable-component",
						style: (0, i$1.normalizeStyle)(h$1.style)
					}, [(0, i$1.renderSlot)(t$2.$slots, "default", {}, void 0, !0), ((0, i$1.openBlock)(!0), (0, i$1.createElementBlock)(i$1.Fragment, null, (0, i$1.renderList)(s$1.active, ((t$3) => (0, i$1.withDirectives)(((0, i$1.openBlock)(), (0, i$1.createElementBlock)("div", {
						key: t$3,
						class: (0, i$1.normalizeClass)("resizable-" + t$3)
					}, null, 2)), [[i$1.vShow, !s$1.maximize]]))), 128))], 4);
				}
				const h = {
					"resizable-r": {
						bit: 1,
				...
				var o = {
					...
					props: {
						...
						active: {
							...
							validator: (t$2) => [
								...
								"t",
								"rt"
							].filter(((e$2) => -1 !== t$2.indexOf(e$2))).length === t$2.length,
							type: Array
						},
						fitParent: {
							default: !1,
					...
					computed: { style() {
						return {
							...this.calcMap & a.w && { width: "number" === typeof this.w ? this.w + "px" : this.w },
							...this.calcMap & a.h && { height: "number" === typeof this.h ? this.h + "px" : this.h },
							...this.calcMap & a.l && { left: "number" === typeof this.l ? this.l + "px" : this.l },
							...this.calcMap & a.t && { top: "number" === typeof this.t ? this.t + "px" : this.t }
						};
					} },
					watch: {
						maxWidth(t$2) {
					...
					methods: {
						setMaximize(t$2) {
							const e$2 = this.$el.parentElement;
							t$2 ? (this.prevState = {
								w: this.w,
								h: this.h,
								l: this.l,
								t: this.t
							}, this.t = this.l = 0, this.w = e$2.clientWidth, this.h = e$2.clientHeight) : this.restoreSize();
						},
						restoreSize() {
							this.prevState && (this.l = this.prevState.l, this.t = this.prevState.t, this.h = this.prevState.h, this.w = this.prevState.w);
						},
						setupDragElements(t$2) {
							this.$el.querySelectorAll(".drag-el").forEach(((t$3) => {
								t$3.classList.remove("drag-el");
							}));
							const i$2 = this.$el.querySelectorAll(t$2);
							i$2.forEach(((t$3) => {
								t$3.classList.add("drag-el");
							})), this.dragElements = Array.prototype.slice.call(i$2);
						},
						emitEvent(t$2, e$2) {
							this.$emit(t$2, {
								eventName: t$2,
						...
						handleMove(t$2) {
							if (0 !== this.resizeState) {
								let e$2, i$2;
								if (this.dragState || (isNaN(this.w) && (this.w = this.$el.clientWidth), isNaN(this.h) && (this.h = this.$el.clientHeight)), t$2.touches && t$2.touches.length >= 0 ? (e$2 = t$2.touches[0].clientY, i$2 = t$2.touches[0].clientX) : (e$2 = t$2.clientY, i$2 = t$2.clientX), this.maximize && this.prevState) {
									const t$3 = this.parent.width, s$2 = this.parent.height;
									this.restoreSize(), this.prevState = void 0, this.t = e$2 > s$2 / 2 ? s$2 - this.h : 0, this.l = i$2 > t$3 / 2 ? t$3 - this.w : 0, this.emitEvent("maximize", { state: !1 });
								}
								let s$1 = i$2 - this.mouseX + this.offsetX, n$1 = e$2 - this.mouseY + this.offsetY;
								if (this.$el.getBoundingClientRect) {
									const t$3 = this.$el.getBoundingClientRect(), e$3 = t$3.width / this.$el.offsetWidth || 1, i$3 = t$3.height / this.$el.offsetHeight || 1;
									s$1 /= e$3, n$1 /= i$3;
								}
								this.offsetX = this.offsetY = 0, this.resizeState & h["resizable-r"].bit && (!this.dragState && this.w + s$1 < this.minW ? this.offsetX = s$1 - (s$1 = this.minW - this.w) : !this.dragState && this.maxW && this.w + s$1 > this.maxW && (!this.fitParent || this.w + this.l < this.parent.width) ? this.offsetX = s$1 - (s$1 = this.maxW - this.w) : this.fitParent && this.l + this.w + s$1 > this.parent.width && (this.offsetX = s$1 - (s$1 = this.parent.width - this.l - this.w)), this.calcMap & a.w && (this.w += this.dragState ? 0 : s$1)), this.resizeState & h["resizable-b"].bit && (!this.dragState && this.h + n$1 < this.minH ? this.offsetY = n$1 - (n$1 = this.minH - this.h) : !this.dragState && this.maxH && this.h + n$1 > this.maxH && (!this.fitParent || this.h + this.t < this.parent.height) ? this.offsetY = n$1 - (n$1 = this.maxH - this.h) : this.fitParent && this.t + this.h + n$1 > this.parent.height && (this.offsetY = n$1 - (n$1 = this.parent.height - this.t - this.h)), this.calcMap & a.h && (this.h += this.dragState ? 0 : n$1)), this.resizeState & h["resizable-l"].bit && (!this.dragState && this.w - s$1 < this.minW ? this.offsetX = s$1 - (s$1 = this.w - this.minW) : !this.dragState && this.maxW && this.w - s$1 > this.maxW && this.l >= 0 ? this.offsetX = s$1 - (s$1 = this.w - this.maxW) : this.fitParent && this.l + s$1 < 0 && (this.offsetX = s$1 - (s$1 = -this.l)), this.calcMap & a.l && (this.l += s$1), this.calcMap & a.w && (this.w -= this.dragState ? 0 : s$1)), this.resizeState & h["resizable-t"].bit && (!this.dragState && this.h - n$1 < this.minH ? this.offsetY = n$1 - (n$1 = this.h - this.minH) : !this.dragState && this.maxH && this.h - n$1 > this.maxH && this.t >= 0 ? this.offsetY = n$1 - (n$1 = this.h - this.maxH) : this.fitParent && this.t + n$1 < 0 && (this.offsetY = n$1 - (n$1 = -this.t)), this.calcMap & a.t && (this.t += n$1), this.calcMap & a.h && (this.h -= this.dragState ? 0 : n$1)), this.mouseX = i$2, this.mouseY = e$2;
								const r$1 = this.dragState ? "drag:move" : "resize:move";
								this.emitEvent(r$1);
							}
						},
						handleDown(t$2) {
							if (!t$2.target.closest || t$2.target.closest(".resizable-component") === this.$refs["parent"]) {
								for (let e$2 in h) if (this.$el.contains(t$2.target) && (t$2.target.closest && t$2.target.closest(`.${e$2}`) || t$2.target.classList.contains(e$2))) {
									"drag-el" === e$2 && (this.dragState = !0), document.body.style.cursor = h[e$2].cursor, t$2.touches && t$2.touches.length >= 1 ? (this.mouseX = t$2.touches[0].clientX, this.mouseY = t$2.touches[0].clientY) : (t$2.preventDefault && t$2.preventDefault(), this.mouseX = t$2.clientX, this.mouseY = t$2.clientY), this.offsetX = this.offsetY = 0, this.resizeState = h[e$2].bit, this.parent.height = this.$el.parentElement.clientHeight, this.parent.width = this.$el.parentElement.clientWidth;
									const i$2 = this.dragState ? "drag:start" : "resize:start";
									this.emitEvent(i$2);
									break;
								}
							}
						...
						handleUp() {
							if (0 !== this.resizeState) {
								...
								const t$2 = this.dragState ? "drag:end" : "resize:end";
								this.emitEvent(t$2), this.dragState = !1;
							}
						}
					}
				};
				var d = (0, (s(733), s(82)).Z)(o, [["render", r], ["__scopeId", "data-v-3de5149f"]]), u = d, m = u;
			}(), n;
		}();
	}));
}) });
